...
import comeAndSeek from "../assets/ComeAndSeekUs.mp4";
...
const SHThirdClue = () => {
	...
	return (
		<section className="sh-step sh-third-clue">
			<h2>Clue 3</h2>
			<video className="sh-media" src={comeAndSeek} controls />
			<button onClick={() => setShowHint(!showHint)}>
				{showHint ? "Hide Hint" : "Show Hint"}
			</button>
			{showHint && <p className="hint">Hint: Think about what the egg represents. Where should you go next?</p>}
		</section>
	);
};
